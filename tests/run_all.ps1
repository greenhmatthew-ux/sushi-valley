...
$allSuites = @(
	...
	"test_role_logic", "test_world_behavior_def", "test_enemy_world_state", "test_terrain_scatter", "test_region_reachability", "test_ability_logic", "test_consumables", "test_crafting", "test_smithing_chain", "test_encounter_director", "test_actor_collision", "test_combat_panel", "test_input_hints", "test_world_map_graph", "test_player_menu", "test_session_summary", "test_toast_feed", "test_hud_review_cue", "test_objective_hud", "test_ui_fits", "test_door_signage", "test_world_art", "test_item_icons", "test_resource_node_siting",
	"smoke_autoloads"
)
