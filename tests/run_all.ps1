...
$suites = @(
	...
	"test_save", "test_transitions", "test_quest", "test_quest_giver", "test_teacher_npc", "test_sign_post", "test_study_spot", "test_combat_encounter", "test_shop_haggle", "test_japanese_sourcing",
	"smoke_autoloads"
)
