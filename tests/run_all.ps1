...
$allSuites = @(
	...
	"test_save", "test_inventory_persistence", "test_farm", "test_weather", "test_fishing", "test_gathering", "test_transitions", "test_quest", "test_quest_reachable", "test_quest_journal", "test_activity_tracker", "test_quest_giver", "test_teacher_npc", "test_raid", "test_expedition", "test_expedition_room", "test_sign_post", "test_study_spot", "test_combat_encounter", "test_player_stats", "test_shop_haggle", "test_japanese_sourcing", "test_card_content", "test_bestiary",
	"test_role_logic", "test_world_behavior_def", "test_enemy_world_state", "test_terrain_scatter", "test_region_reachability", "test_ability_logic", "test_consumables", "test_crafting", "test_smithing_chain", "test_encounter_director", "test_actor_collision", "test_combat_panel", "test_combat_visuals", "test_input_hints", "test_world_map_graph", "test_player_menu", "test_session_summary", "test_toast_feed", "test_hud_review_cue", "test_objective_hud", "test_ui_fits", "test_door_signage", "test_world_art", "test_item_icons", "test_resource_node_siting", "test_interiors_differ", "test_door_paths", "test_ground_not_flat", "test_npc_faces_differ", "test_nodes_reachable", "test_paths_connected", "test_ui_type_scale", "test_world_events", "test_content_staging",
	"smoke_autoloads"
)
