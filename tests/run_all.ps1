...
$suites = @(
	...
	"test_ability_logic", "test_consumables", "test_crafting", "test_combat_panel", "test_player_menu", "test_session_summary", "test_toast_feed", "test_hud_review_cue", "test_objective_hud", "test_ui_fits", "test_door_signage",
	"smoke_autoloads"
)
